...
import com.example.moviefilmapp.Adapters.ActorsListApdapter;
import com.example.moviefilmapp.Adapters.CategoryEachFilmListAdapter;
import com.example.moviefilmapp.Domain.FilmItem;
...
public class DetailActivity extends AppCompatActivity {
    ...
    private void sendRequest() {
        ...
        mStringRequest = new StringRequest(Request.Method.GET, "https://moviesapi.ir/api/v1/movies/" + idFilm, response -> {
            ...
            if (item.getImages() != null){
                adapterActorList = new ActorsListApdapter(item.getImages());
    ...
    private void initView() {
        ...
        movieSummaryInfo = findViewById(R.id.movieSummery2);
        movieActorInfo = findViewById(R.id.movieActorInfo);
        backImg = findViewById(R.id.backImg);
        recyclerViewCategory = findViewById(R.id.genreView);
        recyclerViewActors = findViewById(R.id.actorRecycleView);
